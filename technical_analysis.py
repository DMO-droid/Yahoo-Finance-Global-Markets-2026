"""
BƯỚC 2 — PHÂN TÍCH KỸ THUẬT & MOMENTUM
========================================
Yahoo Finance Global Markets 2026
Chạy: python technical_analysis.py
Output: technical_analysis_report.png (dashboard 6 charts)
         tech_signals_summary.csv      (bảng tín hiệu toàn bộ equity)
         watchlist_strong_buy.csv      (shortlist chất lượng cao)
"""
